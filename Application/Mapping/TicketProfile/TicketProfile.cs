    ...
    public class TicketProfile : Profile
    {
        ...
        public TicketProfile()
        {
           ...
           .ForMember(
            ...
            CreateMap<updateTicketDto, Ticket>().ForMember(des => des.UpdatedDate, src => src.MapFrom(opt => DateTime.UtcNow)).ForMember(dest => dest.AttachmentPath, opt => opt.Ignore()) // تجاهل في البداية
            .AfterMap((src, dest) =>
            {
                if (src.ImageFile != null)
                {
